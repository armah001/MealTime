...
type NavigationProp = StackNavigationProp<RootStackParamList, 'MenuConfigPage'>;

const SetMealDay: React.FC = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.button}>
        <CustomButton title='Next' buttonWidth={355} onPress={undefined} />
      </View>
      <Modal
        animationType="slide"
        transparent={true}
